 ...
 * Pagina Contact
 *
 * Variabile disponibile (din PageController::contact):
 * @var string $csrf_token - token CSRF pentru formular
 * @var array  $settings   - setarile site-ului
 */
$_s = $settings ?? [];
$_email = setting($_s, 'contact_email', 'office@scanbox.ro');
$_phone = setting($_s, 'contact_phone', '0740 233 353');
$_address = setting($_s, 'contact_address', 'Str. Moroeni 60D, Sector 2, București');
$_hours = setting($_s, 'contact_working_hours', 'Luni - Vineri, 09:00 - 18:00');
...
$_sameAs = array_filter([$_instagram, $_facebook, $_tiktok, $_youtube, $_linkedin]);
$_sameAsJson = json_encode(array_values($_sameAs), JSON_UNESCAPED_SLASHES);

$metaDescription = 'Contactează Scanbox.ro pentru soluții vizuale profesionale in București. E-mail: ' . htmlspecialchars($_email) . ', telefon: ' . htmlspecialchars($_phone) . '. Sediu: ' . htmlspecialchars($_address) . '. Program: ' . htmlspecialchars($_hours) . '. Formular de contact cu răspuns rapid.';
$schemaJsonLd = '
<script type="application/ld+json">
{
  ...
  "telephone": "' . htmlspecialchars($_phone) . '",
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    {"@type": "ListItem", "position": 2, "name": "Contact", "item": "https://scanbox.ro/contact"}
  ]
}
</script>
';
...
<?php
$heroBadge = 'Contact';
$heroBadgeIcon = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>';
$heroTitle = 'Contact';
$heroSubtitle = 'Hai să discutăm despre proiectul tău!';
    ...
    <div class="contact-grid">
      ...
      <div class="contact-info">
        ...
        <div class="contact-detail">
          ...
          <div>
            <span><?= htmlspecialchars($_phone) ?></span>
            <small>Telefon</small>
          </div>
        </div>
        ...
        <div style="margin-top: 32px; margin-bottom: 32px;">
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 16px; color: #E2E8F0;">Social Media</h3>
        ...
        <!-- Company Details -->
        <div style="margin-top: 40px; padding: 28px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.06); border-radius: 20px;">
          <h3 style="font-size: 16px; font-weight: 600; margin-bottom: 16px; color: #E2E8F0;">Date Companie</h3>
          <div style="font-size: 14px; color: #94A3B8; line-height: 1.8;">
            <p><strong style="color: #E2E8F0;">TRIVIT SERVICES S.R.L.</strong></p>
            <p>C.I.F.: RO40262760</p>
            <p>Reg. Com: J40/17439/2018</p>
            <p><?= htmlspecialchars($_address) ?></p>
            <p style="margin-top: 12px;"><strong style="color: #E2E8F0;">IBAN RON:</strong></p>
            <p>RO37BTRLRONCRT0478793901</p>
